...
// ดึงข้อมูลรถประเภท "จักรยานยนต์" จากฐานข้อมูลที่ยังไม่ถูกขาย
$query = "SELECT * FROM cars WHERE type = 'จักรยานยนต์' AND sale_status = 'available'";
...
<body class="bg-gray-100">
    ...
    <!-- Section: Display Motorcycles as Cards -->
    <section id="motorcycles" class="py-10">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-2xl font-bold text-gray-700 mb-6">จักรยานยนต์ที่น่าสนใจ</h2>
            <div id="cards-container" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php while($car = mysqli_fetch_assoc($result)) { ?>
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                        <img src="<?= $car['image']; ?>" alt="Motorcycle Image" class="w-full h-48 object-cover">
                        <div class="p-4">
