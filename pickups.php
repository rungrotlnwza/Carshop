...
// ดึงข้อมูลรถประเภท "รถยนต์" จากฐานข้อมูล
$query = "SELECT * FROM cars WHERE type = 'รถยนต์'";
...
<body class="bg-gray-100">
            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex space-x-4">
                    ...
                    <?php if ($is_admin): ?>
                        ...
                        <a href="order.php" class="text-gray-700 hover:text-blue-500">Orders</a> <!-- เพิ่มลิงก์ไปยังหน้า Order -->
                    <?php endif; ?>
                </div>
    ...
    <!-- Section: Display Sedans as Cards -->
    <section id="sedans" class="py-10">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-2xl font-bold text-gray-700 mb-6">รถยนต์ที่น่าสนใจ</h2>
            <div id="cards-container" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php while($car = mysqli_fetch_assoc($result)) { ?>
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                        <img src="<?= $car['image']; ?>" alt="Sedan Image" class="w-full h-48 object-cover">
                        <div class="p-4">
