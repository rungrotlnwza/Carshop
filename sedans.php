...
// ดึงข้อมูลรถประเภท "รถเก๋ง" ที่ยังไม่ขายจากฐานข้อมูล
$query = "SELECT * FROM cars WHERE type = 'รถเก๋ง' AND sale_status = 'available'";
...
<body class="bg-gray-100">
    ...
    <section id="sedans" class="py-10">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-2xl font-bold text-gray-700 mb-6">รถเก๋งที่น่าสนใจ</h2>
