...
// ดึงข้อมูลรถที่ยังไม่ได้ขายจากฐานข้อมูล
$query = "SELECT * FROM cars WHERE sale_status = 'available'";
...
<body class="bg-gray-100">
            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex space-x-4">
                    ...
                    <?php if ($is_admin): ?>
                        ...
                        <a href="order.php" class="text-gray-700 hover:text-blue-500">Orders</a> <!-- ลิงก์ Orders -->
                    <?php endif; ?>
                </div>
    ...
    <!-- Section: Display Cars as Cards -->
    <section id="popular" class="py-10">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-2xl font-bold text-gray-700 mb-6">รถยอดฮิตหรือแนะนำ</h2>
                ...
                <?php while($car = mysqli_fetch_assoc($result)) { ?>
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <!-- เพิ่มลิงก์ไปยังหน้า detail.php -->
